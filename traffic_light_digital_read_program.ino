...
if (IR1 ==LOW && IR2 ==LOW && IR3 ==LOW && IR4 ==HIGH)
  { 
  ...
  //L L H L
  else if (IR1 == LOW && IR2 == LOW && IR3 == HIGH && IR4 == LOW)
  {
    digitalWrite(R1, HIGH); //g3 high
    digitalWrite(Y1, LOW);
    digitalWrite(G1, LOW);
  ...
  //L H L H
  else if (IR1 == LOW && IR2 == HIGH && IR3 == LOW && IR4 == HIGH)
  {
    digitalWrite(R1, HIGH); //g2 high
    digitalWrite(Y1, LOW);
    digitalWrite(G1, LOW);
  ...
  //L H H L
  else if (IR1 == LOW && IR2 == HIGH && IR3 == HIGH && IR4 == LOW)
  { digitalWrite(R1, HIGH); //g2 high
    digitalWrite(Y1, LOW);
    digitalWrite(G1, LOW);
  ...
  //H L L L
  else if (IR1 == HIGH && IR2 == LOW  && IR3 == LOW && IR4 == LOW)
  ...
  //H L H L
  else if (IR1 == HIGH && IR2 == LOW && IR3 == HIGH && IR4 == LOW)
  { digitalWrite(R1, LOW); //g1 high
    digitalWrite(Y1, LOW);
    digitalWrite(G1, HIGH);
